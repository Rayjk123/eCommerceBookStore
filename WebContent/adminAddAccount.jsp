...
<div class="half-width">
	<form action="AdminAccountsServlet" method="post">
        ...
        <label class="reg-label">Street: </label><input class="reg-input" type="text" name="street" required><br>
        <label class="reg-label">City: </label><input class="reg-input" type="text" name="city" required><br>
        ...
        <br>
        <label class="reg-label">Zip Code: </label><input class="reg-input" type="text" name="zip" required>
        <br>
        <br>
        <br>
        <b>Billing Address:</b>
        ...
        <div id="billing-address">
            <label class="reg-label">Street: </label><input class="reg-input" type="text" name="b-street"><br>
            <label class="reg-label">City: </label><input class="reg-input" type="text" name="b-city"><br>
            <label class="reg-label">State: </label>
            ...
            <br>
            <label class="reg-label">Zip Code: </label><input class="reg-input" type="text" name="b-zip">
        </div>
        <br>
        <br>
        <br>
